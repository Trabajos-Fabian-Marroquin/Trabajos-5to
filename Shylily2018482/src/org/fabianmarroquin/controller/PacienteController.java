...
public class PacienteController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fNacimiento.getStylesheets().add("/org/fabianmarroquin/resource/DatePicker.css");
        ...
        fPV.getStylesheets().add("/org/fabianmarroquin/resource/DatePicker.css");
    ...
    public void seleccionarElemento(){
        ...
        } else JOptionPane.showMessageDialog(null, "Tiene que seleccionar un Elemento");
    }
    ...
    public void eliminar(){
        switch (tipoDeOperaciones){
            ...
            default:
                if(tblPacientes.getSelectionModel().getSelectedItem() != null){
                    int respuesta = JOptionPane.showConfirmDialog(null, "¿Esta seguro de eliminar este registro?", "Eliminar Paciente", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    public void actualizar(){
        try{
            PreparedStatement procedimiento = Conexion.getInstance().getConexion().prepareCall("{Call sp_UpdatePacientes(?, ?, ?, ?, ?, ?, ?, ?)}");
